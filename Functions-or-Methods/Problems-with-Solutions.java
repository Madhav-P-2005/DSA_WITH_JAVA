...
// Write a Java program to find the prime number using method (my logic)?
class Prime
{
    public static void main(String args[]) {
        Scanner sc = new Scanner(System.in);
...
// Write a java program to check whether a number is Armstrong or not using Method (my logic)?
class Armstrong
{
    public static void main(String[] args) {
        int  num;
...
// Write a java program to print all 3 Armstrong numbers using Method (kunal's logic)?
class Questions
{
    public static void main(String[] args)
    {
